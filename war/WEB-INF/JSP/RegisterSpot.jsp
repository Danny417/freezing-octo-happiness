...
<html>
  ...
  <form class="form-horizontal" role="form">
    ...
    <!-- parking spot ID-->
     <div class="form-group">
        ...
        <div class="col-sm-10">
          <p class="form-control-static">00123 -- this should be autogenerated</p>
        </div>
    </div>
  ...
  <div class="form-group" style="margin-right:40px;">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputHost" placeholder="Host name">
    </div>
  </div>
  ...
  <div class="form-group" style="margin-right:40px;">
    ...
    <div class="col-sm-2">
      <input type="number" class="form-control" id="inputPrice" placeholder="Price per hour">
    </div>
  </div>
